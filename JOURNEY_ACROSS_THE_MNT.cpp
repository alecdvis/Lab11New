...
int main() {
    ...
    std::shared_ptr<Profession> OLEKAS = CharacterFactory::GetCharacterFactory().CreateCharacter(CharacterFactory::OLEKAS_majorType, 
    CharacterFactory::OLEKAS_professionType, "PROFESSOR OLEKAS"); //final boss
